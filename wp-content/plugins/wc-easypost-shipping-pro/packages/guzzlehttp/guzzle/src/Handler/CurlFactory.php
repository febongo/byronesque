...
namespace OneTeamSoftware\Packages\GuzzleHttp\Handler;

use OneTeamSoftware\Packages\GuzzleHttp\Exception\ConnectException;
use OneTeamSoftware\Packages\GuzzleHttp\Exception\RequestException;
use OneTeamSoftware\Packages\GuzzleHttp\Promise as P;
use OneTeamSoftware\Packages\GuzzleHttp\Promise\FulfilledPromise;
use OneTeamSoftware\Packages\GuzzleHttp\Promise\PromiseInterface;
use OneTeamSoftware\Packages\GuzzleHttp\Psr7\LazyOpenStream;
use OneTeamSoftware\Packages\GuzzleHttp\TransferStats;
use OneTeamSoftware\Packages\GuzzleHttp\Utils;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf) : void
    {
        ...
        if (!isset($options['sink'])) {
            ...
            $options['sink'] = \OneTeamSoftware\Packages\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (!\is_string($sink)) {
            $sink = \OneTeamSoftware\Packages\GuzzleHttp\Psr7\Utils::streamFor($sink);
