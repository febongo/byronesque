...
if ( ! function_exists( 'corsen_core_add_standard_header_options' ) ) {
	/**
	 ...
	 */
	function corsen_core_add_standard_header_options( $page, $general_header_tab ) {

		$section = $general_header_tab->add_section_element(
			array(
				'name'        => 'qodef_standard_header_section',
				'title'       => esc_html__( 'Standard Header', 'corsen-core' ),
				'description' => esc_html__( 'Standard header settings', 'corsen-core' ),
				'dependency'  => array(
					'show' => array(
	...
	add_action( 'corsen_core_action_after_header_options_map', 'corsen_core_add_standard_header_options', 10, 2 );
}
