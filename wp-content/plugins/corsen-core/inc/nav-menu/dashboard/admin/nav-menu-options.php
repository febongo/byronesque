...
if ( ! function_exists( 'corsen_core_nav_menu_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function corsen_core_nav_menu_options( $page ) {
		...
		if ( $page ) {
			$main_menu_tab = $page->add_tab_element(
				array(
					...
					'icon'  => 'fa fa-cog',
					'title' => esc_html__( 'Main Menu Settings', 'corsen-core' ),
				)
			);
			...
			$section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Dropdown Background Color', 'corsen-core' ),
					'description' => esc_html__( 'Set header menu dropdown color', 'corsen-core' ),
				)
			);
			...
			$section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Main Menu Dropdown Appearance', 'corsen-core' ),
					'default_value' => 'default',
					'options'       => array(
						'default'        => esc_html__( 'Default', 'corsen-core' ),
						'animate-height' => esc_html__( 'Animate Height', 'corsen-core' ),
					),
				)
			);
			...
			$section->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Wide Dropdown Full Width', 'corsen-core' ),
					'default_value' => 'yes',
				)
			);
			...
			$row_dropdown_content->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Wide Dropdown Background Color', 'corsen-core' ),
					'args'       => array(
						'col_width' => 4,
					),
				)
			...
			$row_dropdown_content->add_field_element(
				array(
					...
					'title'         => esc_html__( 'Wide Dropdown Content In Grid', 'corsen-core' ),
					'default_value' => 'yes',
					'args'          => array(
						'col_width' => 4,
					),
			...
			$nav_menu_typography_section = $main_menu_tab->add_section_element(
				array(
					...
					'title' => esc_html__( 'Main Menu Typography', 'corsen-core' ),
				)
			);
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Hover/Active Text Decoration', 'corsen-core' ),
					'options'    => corsen_core_get_select_type_options_pool( 'text_decoration' ),
					'args'       => array(
						'col_width' => 3,
					),
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Margin Left/Right', 'corsen-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$first_level_typography_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Padding Left/Right', 'corsen-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$second_level_wide_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Menu Second Level Wide Typography', 'corsen-core' ),
				)
			);
			...
			$third_level_wide_typography_row = $nav_menu_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Menu Third Level Wide Typography', 'corsen-core' ),
				)
			);
	...
	add_action( 'corsen_core_action_after_header_options_map', 'corsen_core_nav_menu_options' );
}
