			...
			<li class="qodef-woo-mini-cart-item qodef-e">
				...
				echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
					...
					sprintf(
                        ...
                        corsen_get_svg_icon( 'cart-remove')
					),
					$cart_item_key
				);
				?>
				...
				<div class="qodef-e-content">
                    ...
                    <div  class="qodef-e-quantity-holder">
                        <p class="qodef-e-quantity"><?php echo sprintf( esc_html__( '%s', 'corsen-core' ), esc_attr( $cart_item['quantity'] ) ); ?></p>
                        <?php corsen_core_render_svg_icon( 'cart-multiply', 'qodef-e-quantity-multiply' ); ?>
