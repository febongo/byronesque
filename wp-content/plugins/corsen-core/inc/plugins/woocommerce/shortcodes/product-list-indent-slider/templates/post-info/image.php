<?php
$product_list_indent_slider_image = get_post_meta( get_the_ID(), 'qodef_product_list_image', true );
$has_image          = ! empty( $product_list_indent_slider_image ) || has_post_thumbnail();
...
if ( $has_image ) {
	...
	echo corsen_core_get_list_shortcode_item_image( $image_dimension, $product_list_indent_slider_image, $custom_image_width, $custom_image_height );
}
