...
if ( class_exists( 'CorsenCore_Dashboard_Rest_API' ) ) {
	class CorsenCore_Dashboard_Theme_Validation extends CorsenCore_Dashboard_Rest_API {
		...
		/**
		 * @return CorsenCore_Dashboard_Rest_API|CorsenCore_Dashboard_Theme_Validation
		 */
		...
		public function register_rest_api_route() {
			...
			register_rest_route(
				...
				array(
					...
					'callback'            => array( CorsenCore_Dashboard::get_instance(), 'theme_validation' ),
	...
	CorsenCore_Dashboard_Theme_Validation::get_instance();
}
