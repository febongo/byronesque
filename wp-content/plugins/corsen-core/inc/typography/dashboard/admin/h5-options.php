...
if ( ! function_exists( 'corsen_core_add_h5_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function corsen_core_add_h5_typography_options( $page ) {
		...
		if ( $page ) {
			$h5_tab = $page->add_tab_element(
				array(
					'name'        => 'tab-h5',
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'H5 Typography', 'corsen-core' ),
					'description' => esc_html__( 'Set values for Heading 5 HTML element', 'corsen-core' ),
				)
			);
	...
	add_action( 'corsen_core_action_after_typography_options_map', 'corsen_core_add_h5_typography_options' );
}
