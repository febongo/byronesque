<?php
$is_enabled = corsen_core_get_post_value_through_levels( 'qodef_portfolio_enable_navigation' );

if ( 'yes' === $is_enabled ) {
	$through_same_category = 'yes' === corsen_core_get_post_value_through_levels( 'qodef_portfolio_navigation_through_same_category' );
	?>
	<div id="qodef-single-portfolio-navigation" class="qodef-m">
		<div class="qodef-m-inner">
			...
			$post_navigation        = array(
				'prev'      => array(
					'label' => '<span class="qodef-m-nav-label">' . esc_html__( 'Prev post', 'corsen-core' ) . '</span>',
					'icon'  => '',
				),
				'back-link' => array(),
				'next'      => array(
					'label' => '<span class="qodef-m-nav-label">' . esc_html__( 'Next post', 'corsen-core' ) . '</span>',
					'icon'  => '',
				),
			);
			...
			if ( '' !== $back_to_link ) {
				$post_navigation['back-link'] = array(
					...
					'icon'    => corsen_get_svg_icon( 'back-to-link', 'qodef-m-back-to-link' ),
				);
			}
