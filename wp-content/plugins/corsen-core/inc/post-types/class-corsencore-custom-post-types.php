...
if ( ! class_exists( 'CorsenCore_Custom_Post_Types' ) ) {
	class CorsenCore_Custom_Post_Types {
		...
		/**
		 * @return CorsenCore_Custom_Post_Types
		 */
		...
		function init() {
			...
			include_once CORSEN_CORE_CPT_PATH . '/dashboard/customizer/post-types-customizer-options.php';
		}
		...
		function set_enabled_post_types() {
			...
			do_action( 'corsen_core_action_add_custom_post_type', $this );
		}
		...
		function register_post_types() {
			...
			$cpts           = apply_filters( 'corsen_core_filter_register_custom_post_types', $cpts = array() );
		...
		function include_taxonomies() {
			...
			do_action( 'corsen_core_action_include_cpt_tax_fields' );
		}

		function register_taxonomies() {
			// Hook to includes custom post types taxonomy fields
			do_action( 'corsen_core_action_register_cpt_tax_fields' );
		}
	...
	CorsenCore_Custom_Post_Types::get_instance();
}
