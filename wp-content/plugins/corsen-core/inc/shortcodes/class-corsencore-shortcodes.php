...
if ( ! class_exists( 'CorsenCore_Shortcodes' ) ) {
	class CorsenCore_Shortcodes {
		...
		function init() {
			...
			include_once CORSEN_CORE_SHORTCODES_PATH . '/dashboard/customizer/shortcodes-customizer-options.php';
		}
		...
		function include_shortcode_classes() {
			include_once CORSEN_CORE_SHORTCODES_PATH . '/class-corsencore-shortcode.php';
			include_once CORSEN_CORE_SHORTCODES_PATH . '/class-corsencore-list-shortcode.php';
		}
		...
		function register_shortcodes() {
			...
			$shortcodes     = apply_filters( 'corsen_core_filter_register_shortcodes', $shortcodes = array() );
	...
	CorsenCore_Shortcodes::get_instance();
}
