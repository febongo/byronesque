=== WC Vendors - WooCommerce Marketplace, WooCommerce Multi-Vendor, Product Vendors ===
Contributors: jkohlbach, RymeraWebCo, Rymera01, smub
Tags: woocommerce multivendor, woocommerce marketplace, multi vendor, marketplace, product vendors, multi seller, commissions
Donate link: 
...
The original WooCommerce multi-vendor plugin for setting up a WooCommerce marketplace just like Amazon, Ebay, CrateJoy, Etsy, Envato, Shutterstock and more...

== Description ==

= WC Vendors – WooCommerce Marketplace Plugin =
...
* Variable products
* Subscription products with our [WC Vendors WooCommerce Subscriptions addon](https://www.wcvendors.com/product/wc-vendors-woocommerce-subscriptions/?utm_campaign=description&utm_source=wporg&utm_medium=web)
* Booking products with our [WC Vendors WooCommerce Bookings addon](https://www.wcvendors.com/product/wc-vendors-woocommerce-bookings/?utm_campaign=description&utm_source=wporg&utm_medium=web)
* Auctions with our [WC Vendors Simple Auctions addon](https://www.wcvendors.com/product/woocommerce-simple-auctions-integration/?utm_campaign=description&utm_source=wporg&utm_medium=web)
...
**Marketplace Commission Options**
...
Knowledge Base: [Read more about how commissions work](https://docs.wcvendors.com/knowledge-base/wc-vendors-pro-commission/?utm_campaign=description&utm_source=wporg&utm_medium=web)

**Create membership plans for marketplace**

WC Vendors Membership addon allows you to create and sell membership plans to your vendors. Setting different limits for your vendors on what products they can sell.
...
[Create your a multi-vendor membership site](https://www.wcvendors.com/product/wc-vendors-membership/?utm_campaign=description&utm_source=wporg&utm_medium=web)
...
All WooCommerce payment gateways are supported. You can read more about difference between payment gateways and vendor payouts [here](https://www.wcvendors.com/payments-explained/?utm_campaign=faq&utm_source=wporg?utm_medium)
