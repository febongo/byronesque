...
class WC_ShipStation_Integration extends WC_Integration {
	...
	public function __construct() {
		...
		add_filter( 'woocommerce_order_query_args', array( $this, 'add_order_number_query_vars' ), 10, 1 );
	}

	/**
	 * Handle a custom variable query var to get orders with the 'order_number' meta.
	 *
	 * @param array $query_vars - Query vars from WC_Order_Query.
	 *
	 * @return array modified $query_vars
	 */
	public function add_order_number_query_vars( $query_vars ) {
