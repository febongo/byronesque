    ...
    public function replace_fallback_field_if_exists(array $settings)
    {
        ...
        foreach ($settings as $key => $field) {
            if ($field['type'] === static::FIELD_TYPE_CUSTOM_ORIGIN) {
                ...
                $new_settings[static::ORIGIN_ADDRESS] = ['title' => \__('Origin Address', 'flexible-shipping-fedex'), 'type' => 'text', 'custom_attributes' => array('required' => 'required'), 'default' => '', 'class' => 'custom_origin_field'];
                $new_settings[static::ORIGIN_CITY] = ['title' => \__('Origin City', 'flexible-shipping-fedex'), 'type' => 'text', 'custom_attributes' => array('required' => 'required'), 'default' => '', 'class' => 'custom_origin_field'];
                $new_settings[static::ORIGIN_POSTCODE] = ['title' => \__('Origin Postcode', 'flexible-shipping-fedex'), 'type' => 'text', 'custom_attributes' => array('required' => 'required'), 'default' => '', 'class' => 'custom_origin_field'];
                $new_settings[static::ORIGIN_COUNTRY] = ['title' => \__('Origin Country/State', 'flexible-shipping-fedex'), 'type' => 'select', 'options' => [], 'options_generator' => $this->get_options_generator(), 'custom_attributes' => array('required' => 'required'), 'default' => '', 'class' => 'custom_origin_field custom_origin_country'];
            } else {
