<div <?php qode_framework_class_attribute( $holder_classes ); ?>>
	...
	<div class="qodef-m-content">
		<div class="qodef-m-content-inner">
			...
			<div class="qodef-m-title-holder" <?php qode_framework_inline_style( $title_holder_styles ); ?>>
                <?php corsen_core_template_part( 'shortcodes/banner', 'templates/parts/title', '', $params ); ?>
                <?php corsen_core_template_part( 'shortcodes/banner', 'templates/parts/additional-title', '', $params ); ?>
            </div>
			<?php corsen_core_template_part( 'shortcodes/banner', 'templates/parts/text', '', $params ); ?>
			<?php corsen_core_template_part( 'shortcodes/banner', 'templates/parts/button', '', $params ); ?>
		</div>
	</div>
</div>
