...
if ( ! function_exists( 'corsen_core_add_back_to_top_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function corsen_core_add_back_to_top_options( $page ) {
		...
		if ( $page ) {
			...
			$page->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Back to Top Icon SVG Path', 'corsen-core' ),
					'description' => esc_html__( 'Enter your back to top icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'corsen-core' ),
					'dependency'  => array(
						'show' => array(
			...
			$back_to_top_section = $page->add_section_element(
				array(
					...
					'title'      => esc_html__( 'Back to Top Styles', 'corsen-core' ),
					'dependency' => array(
						'show' => array(
							'qodef_back_to_top' => array(
								'values'        => 'yes',
	...
	add_action( 'corsen_core_action_after_general_options_map', 'corsen_core_add_back_to_top_options', 15 );
}
