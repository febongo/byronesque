...
if ( ! function_exists( 'corsen_core_add_portfolio_info_typography_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function corsen_core_add_portfolio_info_typography_options( $page ) {
		...
		if ( $page ) {
			$portfolio_info_tab = $page->add_tab_element(
				array(
					...
					'icon'        => 'fa fa-cog',
					'title'       => esc_html__( 'Portfolio Info', 'corsen-core' ),
					'description' => esc_html__( 'Set typography values for portfolio info elements', 'corsen-core' ),
				)
			);
			...
			$portfolio_info_typography_row = $portfolio_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Info Styles', 'corsen-core' ),
				)
			);
			...
			$portfolio_info_typography_row->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Top Margin - Big Layouts', 'corsen-core' ),
					'description' => esc_html__( 'Set top margin size for portfolio item big layouts on portfolio single page', 'corsen-core' ),
					'args'        => array(
						'col_width' => 6,
					),
				)
			...
			$portfolio_info_typography_row->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Top Margin - Small Layouts', 'corsen-core' ),
					'description' => esc_html__( 'Set top margin size for portfolio item small layouts on portfolio single page', 'corsen-core' ),
					'args'        => array(
						'col_width' => 6,
					),
				)
			...
			$portfolio_info_link_typography_row = $portfolio_info_typography_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Info Link Styles', 'corsen-core' ),
				)
			);
	...
	add_action( 'corsen_core_action_after_portfolio_options_map', 'corsen_core_add_portfolio_info_typography_options' );
}
