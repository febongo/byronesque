...
if ( ! function_exists( 'corsen_core_add_elements_options' ) ) {
	/**
	 * Function that add general options for this module
	 */
	function corsen_core_add_elements_options() {
		...
		$page = $qode_framework->add_options_page(
			array(
				...
				'slug'        => 'elements',
				'icon'        => 'fa fa-book',
				'title'       => esc_html__( 'Elements', 'corsen-core' ),
				'description' => esc_html__( 'Global Elements Options', 'corsen-core' ),
			)
		);
		...
		if ( $page ) {
			...
			$label_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Label Styles', 'corsen-core' ),
				)
			);
			...
			$input_fields_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Input Fields Styles', 'corsen-core' ),
				)
			);
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Focus Color', 'corsen-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Background Focus Color', 'corsen-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Focus Color', 'corsen-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Width', 'corsen-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$input_fields_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Border Radius', 'corsen-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$button_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Button Styles', 'corsen-core' ),
				)
			);
			...
			$button_row->add_field_element(
				array(
					...
					'title'      => esc_html__( 'Box Shadow', 'corsen-core' ),
					'args'       => array(
						'col_width' => 3,
					),
				)
			...
			$button_simple_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Button Textual Styles', 'corsen-core' ),
				)
			);
			...
			$slider_arrow_section = $page->add_section_element(
				array(
					...
					'title' => esc_html__( 'Slider Arrow Styles', 'corsen-core' ),
				)
			);
			...
			$slider_arrow_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Sliders Arrow Left Icon SVG Path', 'corsen-core' ),
					'description' => esc_html__( 'Enter your sliders arrow left icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'corsen-core' ),
				)
			);
			...
			$slider_arrow_section->add_field_element(
				array(
					...
					'title'       => esc_html__( 'Sliders Arrow Right Icon SVG Path', 'corsen-core' ),
					'description' => esc_html__( 'Enter your sliders arrow right icon SVG path here. Please remove version and id attributes from your SVG path because of HTML validation', 'corsen-core' ),
				)
			);
			...
			$slider_arrow_row = $slider_arrow_section->add_row_element(
				array(
					...
					'title' => esc_html__( 'Icon Styles', 'corsen-core' ),
				)
			);
			...
			do_action( 'corsen_core_action_after_elements_options_map', $page );
		}
	}

	add_action( 'corsen_core_action_default_options_init', 'corsen_core_add_elements_options' );
}
