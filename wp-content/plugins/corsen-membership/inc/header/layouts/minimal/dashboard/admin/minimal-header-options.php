...
if ( ! function_exists( 'corsen_core_add_minimal_header_options' ) ) {
	/**
	 ...
	 */
	function corsen_core_add_minimal_header_options( $page, $general_header_tab ) {

		$section = $general_header_tab->add_section_element(
			array(
				'name'       => 'qodef_minimal_header_section',
				'title'      => esc_html__( 'Minimal Header', 'corsen-core' ),
				'dependency' => array(
					'show' => array(
        ...
        $section->add_field_element(
            array(
                'field_type'  => 'text',
                'name'        => 'qodef_minimal_header_side_margin',
	...
	add_action( 'corsen_core_action_after_header_options_map', 'corsen_core_add_minimal_header_options', 10, 2 );
}
