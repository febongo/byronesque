...
if ( ! function_exists( 'corsen_core_add_divided_header_options' ) ) {
	/**
	 ...
	 */
	function corsen_core_add_divided_header_options( $page, $general_header_tab ) {
	...
	add_action( 'corsen_core_action_after_header_options_map', 'corsen_core_add_divided_header_options', 10, 2 );
}
