...
if ( ! class_exists( 'CorsenCore_Dashboard_Rest_API' ) ) {
	 ...
	 */
	class CorsenCore_Dashboard_Rest_API {
		...
		public function __construct() {
			...
			add_filter( 'corsen_core_filter_dashboard_js_global_variables', array( $this, 'localize_script' ) );
		...
		/**
		 * @return CorsenCore_Dashboard_Rest_API
		 */
	...
	CorsenCore_Dashboard_Rest_API::get_instance();
}
