...
if ( ! function_exists( 'corsen_core_add_twitter_list_shortcode' ) ) {
	/**
	 ...
	 * @return array
	 */
	function corsen_core_add_twitter_list_shortcode( $shortcodes ) {
		if ( qode_framework_is_installed( 'twitter' ) ) {
			$shortcodes[] = 'CorsenCore_Twitter_List_Shortcode';
		}

		return $shortcodes;
	}

	add_filter( 'corsen_core_filter_register_shortcodes', 'corsen_core_add_twitter_list_shortcode' );
}

if ( class_exists( 'CorsenCore_List_Shortcode' ) ) {
	class CorsenCore_Twitter_List_Shortcode extends CorsenCore_List_Shortcode {

		public function map_shortcode() {
			$this->set_shortcode_path( CORSEN_CORE_PLUGINS_URL_PATH . '/twitter/shortcodes/twitter-list' );
			$this->set_base( 'corsen_core_twitter_list' );
			$this->set_name( esc_html__( 'Twitter List', 'corsen-core' ) );
			$this->set_description( esc_html__( 'Shortcode that displays twitter list', 'corsen-core' ) );
			$this->set_option(
				array(
					'field_type' => 'text',
					'name'       => 'custom_class',
			...
			$this->set_option(
				array(
					...
					'field_type' => 'text',
					'title'      => esc_html__( 'Number of Tweets', 'corsen-core' ),
					'group'      => esc_html__( 'Info', 'corsen-core' ),
				)
			);
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Retweeted Text', 'corsen-core' ),
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Avatar Image', 'corsen-core' ),
					'options'       => corsen_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'corsen-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Author Name', 'corsen-core' ),
					'options'       => corsen_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'corsen-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Tweet Text', 'corsen-core' ),
					'options'       => corsen_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'corsen-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Media Placeholder', 'corsen-core' ),
			...
			$this->set_option(
				array(
					'name'          => 'show_date',
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Date', 'corsen-core' ),
					'options'       => corsen_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'corsen-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Tweet Actions', 'corsen-core' ),
					'options'       => corsen_core_get_select_type_options_pool( 'yes_no' ),
					'default_value' => 'yes',
					'group'         => esc_html__( 'Info', 'corsen-core' ),
				)
			...
			$this->set_option(
				array(
					...
					'field_type'    => 'select',
					'title'         => esc_html__( 'Show Twitter Link', 'corsen-core' ),
					'options'       => corsen_core_get_select_type_options_pool( 'no_yes' ),
					'default_value' => 'no',
					'group'         => esc_html__( 'Info', 'corsen-core' ),
				)
		...
		public static function call_shortcode( $params ) {
			$html = qode_framework_call_shortcode( 'corsen_core_twitter_list', $params );
			$html = str_replace( "\n", '', $html );
		...
		public function render( $options, $content = null ) {
			...
			return corsen_core_get_template_part( 'plugins/twitter/shortcodes/twitter-list', 'templates/twitter-list', '', $atts );
		}
