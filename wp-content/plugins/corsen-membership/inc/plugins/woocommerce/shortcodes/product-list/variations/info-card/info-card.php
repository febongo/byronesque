...
if ( ! function_exists( 'corsen_core_add_product_list_variation_info_card' ) ) {
	/**
	 ...
	 * @return array
	 */
	function corsen_core_add_product_list_variation_info_card( $variations ) {
		$variations['info-card'] = esc_html__( 'Info Card', 'corsen-core' );

		return $variations;
	}

	add_filter( 'corsen_core_filter_product_list_layouts', 'corsen_core_add_product_list_variation_info_card' );
}

if ( ! function_exists( 'corsen_core_register_shop_list_info_card_actions' ) ) {
	/**
	 * Function that override product item layout for current variation type
	 */
	function corsen_core_register_shop_list_info_card_actions() {
	...
	add_action( 'corsen_core_action_shop_list_item_layout_info-card', 'corsen_core_register_shop_list_info_card_actions' );
}
