...
if ( ! function_exists( 'corsen_core_add_ionicons_to_collection' ) ) {
	/**
	 ...
	 * @return array
	 */
	function corsen_core_add_ionicons_to_collection( $icons ) {
		$icons[] = 'CorsenCore_IonIcons_Pack';

		return $icons;
	}

	add_filter( 'qode_framework_filter_add_icon', 'corsen_core_add_ionicons_to_collection' );
}

if ( class_exists( 'QodeFrameworkIconPack' ) ) {
	class CorsenCore_IonIcons_Pack extends QodeFrameworkIconPack {
		...
		function specific_icons() {
			return apply_filters(
				'corsen_core_filter_ion_specific_icons',
				array(
