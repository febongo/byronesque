...
class CorsenCore_Revealing_Search extends CorsenCore_Search {
	...
	/**
	 * @return CorsenCore_Revealing_Search
	 */
	...
	public function load_template() {
		if ( is_active_widget( false, false, 'corsen_core_search_opener' ) ) {
			...
			$actions         = array();
			$sidebars        = qode_framework_get_widget_sidebars( 'corsen_core_search_opener' );
			...
			/*foreach ( $sidebars as $sidebar ) {
				if ( 'qodef-header-widget-area-one' === $sidebar || 'qodef-header-widget-area-two' === $sidebar ) {
					$actions[] = 'corsen_action_after_page_header_inner';
					$actions[] = 'corsen_core_action_after_sticky_header';
				} elseif ( 'qodef-mobile-header-widget-area' === $sidebar ) {
					$actions[] = 'corsen_action_after_page_mobile_header_inner';
					$actions[] = 'corsen_core_action_after_page_mobile_header_inner';
				} elseif ( 'qodef-top-area-left' === $sidebar || 'qodef-top-area-right' === $sidebar ) {
					$actions[] = 'corsen_core_action_after_top_area';
            ...
            $actions[] = 'corsen_core_action_custom_opener';
