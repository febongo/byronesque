...
<div class="qodef-m-content <?php echo esc_attr( corsen_core_get_page_title_content_classes() ); ?>">
	<<?php echo esc_attr( $title_tag ); ?> class="qodef-m-title entry-title">
		...
		if ( qode_framework_is_installed( 'theme' ) ) {
			echo esc_html( corsen_get_page_title_text() );
		} else {
	...
	corsen_core_template_part( 'title/layouts/standard', 'templates/parts/subtitle', '', corsen_core_get_standard_title_layout_subtitle_text() );
	?>
</div>
