...
if ( ! function_exists( 'corsen_core_mobile_header_menu_options' ) ) {
	/**
	 * Function that add general options for this module
	 *
	 * @param object $page
	 */
	function corsen_core_mobile_header_menu_options( $page ) {
		...
		if ( $page ) {
			$mobile_menu_tab = $page->add_tab_element(
				array(
					...
					'icon'  => 'fa fa-cog',
					'title' => esc_html__( 'Mobile Menu Settings', 'corsen-core' ),
				)
			);
			...
			$typography_section = $mobile_menu_tab->add_section_element(
				array(
					...
					'title'      => esc_html__( 'Mobile Menu Typography', 'corsen-core' ),
					'dependency' => array(
						'hide' => array(
							'qodef_mobile_header_layout' => array(
								'values'        => corsen_core_dependency_for_mobile_menu_typography_options(),
	...
	add_action( 'corsen_core_action_after_mobile_header_options_map', 'corsen_core_mobile_header_menu_options' );
}
