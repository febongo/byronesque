...
<body <?php body_class(); ?> itemscope itemtype="https://schema.org/WebPage">
	...
	do_action( 'corsen_action_after_body_tag_open' );
	?>
	<div id="qodef-page-wrapper" class="<?php echo esc_attr( corsen_get_page_wrapper_classes() ); ?>">
		<?php
		// Hook to include page header template
		do_action( 'corsen_action_page_header_template' );
		?>
		<div id="qodef-page-outer">
			...
			do_action( 'corsen_action_before_page_inner' );
			?>
			<div id="qodef-page-inner" class="<?php echo esc_attr( corsen_get_page_inner_classes() ); ?>">
