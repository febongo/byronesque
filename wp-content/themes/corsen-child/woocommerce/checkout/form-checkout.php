...
<div class="woocommerce-checkout-block" style="width:100%">
	<div class="checkout-details" style="width:70%">
		<?php if ( $checkout->get_checkout_fields() ) : ?>
			<?php do_action( 'woocommerce_checkout_before_customer_details' ); ?>
			<!-- <div class="woocommerce-myaccount-detailblock checkout-left-block"></div>		 -->
			<div class="woocommerce-myaccount-detailblock checkout-details-block">
	...
	<div class="checkout-summary" style="width:30%">
